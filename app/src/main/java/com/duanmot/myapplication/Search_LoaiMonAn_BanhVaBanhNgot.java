...
public class Search_LoaiMonAn_BanhVaBanhNgot extends AppCompatActivity {
    ...
    ArrayList<MonAn> dsMonAnBanhVaBanhNgot;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dsMonAnBanhVaBanhNgot = new ArrayList<>();

        rvSearchLoaiMonAn.setLayoutManager(new GridLayoutManager(Search_LoaiMonAn_BanhVaBanhNgot.this, 2));
    ...
    private void searchMonAnBanhngot(final String s) {
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            ...
                            for (DataSnapshot dataSnapshotLoaiMonAn : dataSnapshot.getChildren()) {
                                ...
                                if (monAn.getMaMonAn().equalsIgnoreCase(phanLoaiMonAn.getMaMonAn())) {
                                    if (phanLoaiMonAn.getThucDon().equalsIgnoreCase("Bánh - Bánh ngọt")) {

                                        if (monAn.getTenMonAn().toLowerCase().contains(s.toLowerCase())) {
                                            dsMonAnBanhVaBanhNgot.add(monAn);
                                        }

                                    }

                                    adapter_monAn_show_home = new Adapter_MonAn_Show_Home(Search_LoaiMonAn_BanhVaBanhNgot.this, dsMonAnBanhVaBanhNgot);
