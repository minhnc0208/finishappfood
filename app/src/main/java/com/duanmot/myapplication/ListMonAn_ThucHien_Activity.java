...
public class ListMonAn_ThucHien_Activity extends AppCompatActivity {
...
//        LinearLayoutManager layoutManager = new LinearLayoutManager(ListMonAn_ThucHien_Activity.this, LinearLayoutManager.VERTICAL, false);
//        mRecyclerViewList.setLayoutManager(layoutManager);

        mRecyclerViewList.setHasFixedSize(true);
        mRecyclerViewList.setLayoutManager(new GridLayoutManager(ListMonAn_ThucHien_Activity.this,2));
        ...
        databaseReferenceMonAn.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (final DataSnapshot dataMonAn : dataSnapshot.getChildren()) {
                    ...
                    DatabaseReference databaseReferenceThucHien = FirebaseDatabase.getInstance().getReference().child("ThucHien").child(monAn1.getMaMonAn());
                    ...
                    databaseReferenceThucHien.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            if (dataSnapshot.child(firebaseUser.getUid()).exists()) {
                                ...
                                adapter_monAn_show_home = new Adapter_MonAn_Show_Home(ListMonAn_ThucHien_Activity.this, listMonAn);
