...
public class Search_LoaiMonAn_TotChoSucKhoe extends AppCompatActivity {
    ...
    ArrayList<MonAn> dsMonAnTotChoSucKhoe;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dsMonAnTotChoSucKhoe = new ArrayList<>();

        rvSearchLoaiMonAn.setLayoutManager(new GridLayoutManager(Search_LoaiMonAn_TotChoSucKhoe.this, 2));
    ...
    private void searchMonAnTotChoSucKhoe(final String s) {
                                ...
                                if (monAn.getMaMonAn().equalsIgnoreCase(phanLoaiMonAn.getMaMonAn())) {
                                    if (phanLoaiMonAn.getMucDich().equalsIgnoreCase("Tốt cho sức khỏe")) {
                                        ...
                                        if (monAn.getTenMonAn().toLowerCase().contains(s.toLowerCase())) {
                                            dsMonAnTotChoSucKhoe.add(monAn);
                                        }

                                    }

                                    adapter_monAn_show_home = new Adapter_MonAn_Show_Home(Search_LoaiMonAn_TotChoSucKhoe.this, dsMonAnTotChoSucKhoe);
