...
public class Search_LoaiMonAn_NhanhVaDe extends AppCompatActivity {
    ...
    ArrayList<MonAn> dsMonAnNhanhVaDe;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dsMonAnNhanhVaDe = new ArrayList<>();

        rvSearchLoaiMonAn.setLayoutManager(new GridLayoutManager(Search_LoaiMonAn_NhanhVaDe.this, 2));
    ...
    private void searchMonAnNhanhVaDe(final String s) {
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            ...
                            for (DataSnapshot dataSnapshotLoaiMonAn : dataSnapshot.getChildren()) {
                                ...
                                if (monAn.getMaMonAn().equalsIgnoreCase(phanLoaiMonAn.getMaMonAn())) {
                                    if (phanLoaiMonAn.getThucDon().equalsIgnoreCase("Nhanh và dễ")) {

                                        if (monAn.getTenMonAn().toLowerCase().contains(s.toLowerCase())) {
                                            dsMonAnNhanhVaDe.add(monAn);
                                        }

                                    }

                                    adapter_monAn_show_home = new Adapter_MonAn_Show_Home(Search_LoaiMonAn_NhanhVaDe.this, dsMonAnNhanhVaDe);
