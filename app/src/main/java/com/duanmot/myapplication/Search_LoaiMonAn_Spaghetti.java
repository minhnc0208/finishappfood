...
public class Search_LoaiMonAn_Spaghetti extends AppCompatActivity {
    ...
    ArrayList<MonAn> dsMonAnSpaghetti;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dsMonAnSpaghetti = new ArrayList<>();

        rvSearchLoaiMonAn.setLayoutManager(new GridLayoutManager(Search_LoaiMonAn_Spaghetti.this, 2));
    ...
    private void searchMonAnSpagetti(final String s) {
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            ...
                            for (DataSnapshot dataSnapshotLoaiMonAn : dataSnapshot.getChildren()) {
                                ...
                                if (monAn.getMaMonAn().equalsIgnoreCase(phanLoaiMonAn.getMaMonAn())) {
                                    if (phanLoaiMonAn.getLoaiMon().equalsIgnoreCase("Pasta - Spaghetti")) {

                                        if (monAn.getTenMonAn().toLowerCase().contains(s.toLowerCase())) {
                                            dsMonAnSpaghetti.add(monAn);
                                        }

                                    }

                                    adapter_monAn_show_home = new Adapter_MonAn_Show_Home(Search_LoaiMonAn_Spaghetti.this, dsMonAnSpaghetti);
